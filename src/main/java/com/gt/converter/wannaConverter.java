...
public class wannaConverter implements HttpMessageConverter<computer> {
    @Override
    ...
    public boolean canWrite(Class<?> clazz, MediaType mediaType) {
        if(mediaType != null) {
            return clazz.isAssignableFrom(computer.class) && mediaType.equals(new MediaType("application","wanna"));
        }
    ...
    public List<MediaType> getSupportedMediaTypes() {
        return MediaType.parseMediaTypes("application/wanna");
    }
    ...
    public void write(computer computer, MediaType contentType, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        String data = computer.getName() + "-----;" + computer.getNumber() + "-----;" + computer.getPrice() + "------;";
